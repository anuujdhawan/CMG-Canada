    ...
    <div className="rounded-brand-2xl border border-line bg-white p-6 shadow-card sm:p-8">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="flex h-11 w-11 items-center justify-center rounded-brand-lg bg-primary text-white shadow-sm">
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2">
        ...
        {/* Spouse + extras */}
        <div className="space-y-4">
          <label className="flex cursor-pointer items-center justify-between rounded-brand-md border border-line bg-surface px-4 py-3 transition-colors hover:border-primary/30">

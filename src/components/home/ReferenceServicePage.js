      ...
      <section className="hero service-hero" aria-labelledby="service-hero-title">
        ...
        <div className="hero-layout">
          <div className="hero-copy reveal in">
            ...
            <div className="hero-trust"><Link href="https://register.college-ic.ca/Public-Register-EN/Licensee/Profile.aspx?ID=18715" target="_blank" rel="noopener noreferrer" className="trust-chip"><ShieldCheck width={16} height={16} aria-hidden="true" /> CICC-regulated</Link><span className="trust-chip"><Target width={16} height={16} aria-hidden="true" /> Strategy-led</span><span className="trust-chip"><Timer width={16} height={16} aria-hidden="true" /> Clear next steps</span></div>
          </div>
          <div className="hero-visual reveal in" aria-label="Service pathway overview">
            <article className="visual-card"><div className="mini-badges"><Link href="https://register.college-ic.ca/Public-Register-EN/Licensee/Profile.aspx?ID=18715" target="_blank" rel="noopener noreferrer" className="mini-badge"><ShieldCheck width={15} height={15} aria-hidden="true" /> CICC-regulated</Link><span className="mini-badge">{slide?.label || "Canada-wide support"}</span></div><h2>One route. One owner. A clearer file.</h2><p>We connect your goal, evidence and deadline into one service plan.</p><div className="visual-stats"><div><strong>01</strong><small>Understand<br />the file</small></div><div><CheckCircle2 width={24} height={24} aria-hidden="true" /><small>Move with<br />confidence</small></div></div></article>
          </div>
        </div>
      </section>

...
- ## Spousal Open Work Permit - What It Is and Who Qualifies in 2026
- ### Designed for Families
- ### No Job Offer Required
- ### Significantly Restricted in 2024
- ### Tied to Principal's Status
- ### Work Experience Toward PR
- ### Genuine Relationship Requirement
- ## Who Still Qualifies for a Spousal OWP?
- ### Spouses of Express Entry PR Applicants
- ### Spouses of High-Skilled Temporary Workers (TEER 0 or 1)
- ### Spouses of International Students - Restricted Since 2024
- ### Spouses under Special Measures (CUAET / Ukraine)
- ### Spouses of Protected Persons or Refugees
...
- #### Confirm Principal's Status Documents
- #### Apply Online via IRCC Portal
- #### Provide Biometrics
- #### Receive OWP and Begin Working
- ## Documents for Your Spousal OWP Application
- #### Relationship Proof
- #### Principal Applicant's Documents
- #### Spouse's Documents
- #### NOC TEER Verification Is Critical
- ## How Long Does a Spousal OWP Last?
- ### Mirrors Principal's Permit
- ### Renew Together with Principal
- ### Status Change Affects OWP
- ## Spousal OWP and Permanent Residence
- ### Build Your Own CEC Express Entry Profile
- ### Both Partners Apply for PR Together
- #### Spousal OWP → Spousal Sponsorship PR
- ### Common Spousal OWP Mistakes
- #### Applying When Bachelor's Student Spouse No Longer Qualifies
- #### Misidentifying Principal's NOC as TEER 0/1
- #### Insufficient Relationship Evidence
- #### Not Coordinating with Principal's Permit Renewal
- #### Traveling Outside Canada When Spousal OWP is Pending
...
A Spousal Open Work Permit (Spousal OWP) allows the spouse or common-law partner of a Canadian work permit holder or student to work for any Canadian employer without a job offer or LMIA. However, 2023-2024 policy changes dramatically narrowed who qualifies.
...
- Express Entry PR application submitted and AOR received
- Spouse must be included in the PR application
- Both hold valid immigration status in Canada
- Principal must have a valid work permit (for BOWP)
...
- Principal holds a valid work permit in Canada
- Principal is working in a NOC TEER 0 or TEER 1 occupation
- Spouse is admissible to Canada
- Marriage or common-law partnership is genuine
...
- Principal must be enrolled full-time in a master's, PhD, or specified professional degree program
...
- Ukrainian national or immediate family member
- Authorized under CUAET emergency measures
- Must maintain valid authorization
- Valid while CUAET program remains in effect
...
| Pre-2023 Rules |
| 2024-2026 Rules |
| Spouse of bachelor's degree student (any DLI) |
| OWP Eligible |
| Not Eligible (2024) |
| Spouse of college diploma student |
| OWP Eligible |
| Not Eligible (2024) |
| Spouse of master's/PhD student (public university) |
| OWP Eligible |
| Still Eligible |
| Spouse of TEER 0/1 worker |
| OWP Eligible |
| Still Eligible |
| Spouse of TEER 2/3 worker |
| OWP Eligible in some cases |
| No longer eligible in most cases |
| Spouse of TEER 4/5 worker |
| Not eligible |
| Not eligible |
| Spouse of Express Entry PR applicant |
| BOWP available |
| BOWP still available |
| Spouse under CUAET |
| OWP eligible |
| Still eligible |
...
- Marriage certificate (official, translated if not in English/French)
- Wedding photographs (ceremony, family, couple)
- Joint bank account statements or property documents
- Communication records (messages, emails, call logs)
- Evidence of cohabitation (shared lease, utility bills)
- Letters from family, friends, or religious authority attesting to relationship

#### Principal Applicant's Documents

- Copy of principal's valid work permit or study permit
- Employment letter showing NOC title and duties (for worker stream)
- Recent pay stubs or T4 showing employment
- Proof of occupation (for TEER confirmation)
- Copy of principal's study permit enrollment letter (for student stream)

#### Spouse's Documents

- Valid passport (all pages)
- Passport-size photographs meeting IRCC specifications
- Current immigration status document (if already in Canada)
- Biometrics (if required)
- Application fee payment (CAD $155)
...
In Express Entry, both the principal applicant and their spouse are included in the same PR application. The spouse's Canadian work experience, education, and language scores can boost the combined CRS score. Including a working spouse on a Spousal OWP often increases Express Entry CRS significantly.
...
The 2024 policy change is the single biggest source of rejected spousal OWP applications. Spouses of international students in bachelor's degree and college programs no longer qualify. Always check current policy before applying.
...
- My husband is on a PGWP - can I get a Spousal OWP?
- My wife is in a college diploma program in Canada - can she get me a spousal OWP?
- We just got married in India - what documents do I need for the Spousal OWP?
- My Spousal OWP expires before my husband's work permit - can I extend it?
- Can I use my Canadian work experience from a Spousal OWP for Express Entry?
- What TEER 0 and TEER 1 NOC codes qualify the principal applicant?
- My spouse has an active refugee claim - can I work in Canada?

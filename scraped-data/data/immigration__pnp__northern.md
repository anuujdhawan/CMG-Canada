...
- # Northern Canada Immigration 2026 - Yukon YNP, NWT NTNP & Nunavut Federal Routes
...
The federal government historically allocates smaller nomination spaces to territories than to provinces. YNP and NTNP have meaningful but limited annual spaces. This means lower competition per available space — the opposite of large-province PNPs.
...
Canadian Experience Class (CEC), Federal Skilled Worker Program (FSW), and Federal Skilled Trades Program (FST) are all available to northern workers who meet the criteria. CEC is most relevant for workers already in Canada building qualifying experience. FSW for internationally trained candidates who meet point thresholds. See [IRCC's Express Entry page](https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry.html) for current rules.
...
- 1 Confirm employer YNP eligibility and stream (Skilled Worker, Critical Impact, EE, or Business)
- 2 Employer submits employer application to YNP; worker prepares worker application simultaneously
- 3 YNP issues nomination certificate (approximately 4-8 weeks for complete submissions)
- 4 Worker applies for federal PR: Express Entry ITA if EE-linked, or base PNP PR application
- 5 Confirm housing and settlement plan in Whitehorse or community employer location

### Northwest Territories (NTNP)

- 1 Confirm NWT employer eligibility and NTNP stream (Employer-Driven or Business Applicant)
- 2 Employer and worker submit joint application package to NTNP
- 3 Respond to NTNP requests - housing and compensation clarifications are common
- 4 Receive NTNP nomination certificate after approval
- 5 File federal PR with IRCC (non-EE base PNP route or EE if applicable)

### Nunavut (Federal Routes Only)

- 1 Confirm housing availability with employer before accepting offer
- 2 Enter on TFWP/LMIA work permit or IMP permit (employer handles LMIA or exemption)
- 3 Accumulate 1 year qualifying Canadian work experience for CEC eligibility
- 4 Build Express Entry profile; submit ITA when CRS-eligible or RNIP community recommendation available
- 5 File federal PR with IRCC; maintain bridging permit while application pending

# BC PNP 2026 | Skills Immigration Registration System (SIRS) | Licensed RCIC

> **Source URL:** https://visamastercanada.com/immigration/pnp/british-columbia
...
- **Title tag:** BC PNP 2026 | Skills Immigration Registration System (SIRS) | Licensed RCIC
- **Meta description:** BC PNP 2026 - 5,254 spaces. SIRS cutoff hits 89, a historic low. Weekly Tuesday draws, $62/hr auto-invite, dual selection. All streams by licensed RCIC.
- **Meta keywords:** (none)
- **Canonical URL:** https://visamastercanada.com/immigration/pnp/british-columbia
- **OG title:** BC PNP 2026 - Complete Guide | Skills Immigration Registration System | Licensed RCIC
- **OG description:** BC PNP 2026 - 5,254 spaces. SIRS cutoff hits 89, a historic low. Weekly Tuesday draws, $62/hr auto-invite, dual selection. All streams by licensed RCIC.
- **Robots:** index, follow

## Heading Outline

- # BC Provincial Nominee Program (BC PNP) 2026
- ## BC PNP Cutoff Scores Are at Historic Lows - But This Window Won't Last
- ## BC PNP SIRS Score Calculator
...
Two numbers tell the whole BC story for 2026: 5,254 nomination spaces — 66% more than last year — and a SIRS cutoff that has fallen from 150 to 89 in under a year. British Columbia's Skills Immigration Registration System draws every Tuesday, and it now rewards candidates two different ways: clear the cutoff on points, or earn $62/hour or more and get invited automatically, full stop. For skilled workers with a genuine BC job offer, there has not been a better window since the program's early days. VMC's licensed RCICs calculate your exact SIRS score and prepare your package before the window closes.
...
- → PNP hub
- → Express Entry
Historic low cutoffs

Secure your SIRS strategy and documents before scores rebound - book a consult.
...
Estimate your BC Skills Immigration Registration System (SIRS) score. Current draws at historic low of 89. Takes 3 minutes.
...
EEBC nominations add 600 CRS points to your federal Express Entry profile — in recent draws, well above every published cutoff (IRCC sets the cutoff each round). PR timeline: approximately 6 months from EEBC nomination. Requires an active federal Express Entry profile (FSW, FST, or CEC) at the time of applying.

### Express Entry BC: Skilled Worker

Mirrors the Skills Immigration Skilled Worker stream but for candidates already in the federal Express Entry pool. All Skilled Worker eligibility criteria apply. Because EEBC nomination adds 600 CRS points, even candidates with modest base CRS scores (e.g., 450-480) place well above recent federal draw cutoffs. This is the fastest route to BC PR for skilled workers with Express Entry profiles.
...
- 1 Step 1 : Confirm eligibility (week 1) Valid BC job offer from an eligible employer, NOC TEER 0-3 or designated ELSS, work experience, wage in line with BC rules. For EEBC, active Express Entry (FSW, FST, or CEC).
- 2 Step 2 : Calculate SIRS score (week 1) Use We's SIRS calculator at /tools. Compare to recent cutoffs; plan upgrades (language, wage, location) if you are below the pool.
- 3 Step 3 : Register in SIRS (week 2) Profile at PNPApplication.gov.bc.ca - no fee until ITA. Stays active up to 2 years.
- 4 Step 4 : Weekly draw → ITA Tuesday draws by score or $62/hr auto-invite. After ITA: 25 business days to file a complete application.
- 5 Step 5 : Pay fee & submit ($1,750) Non-refundable. Incomplete files are returned - prepare the full package before you rely on an ITA.
- 6 Step 6 : BC processes (≈2-5 mo.) Typical skilled worker 2-3 months; healthcare often faster; EEBC often 2-4 months. Reply quickly to ADRs.
- 7 Step 7 : Nomination issued SI: apply to IRCC for PR. EEBC: add +600 CRS in EE and expect a federal ITA soon after.
- 8 Step 8 : PR with IRCC SI nominees often see ≈12-18 months federal processing; EEBC nominees often ≈6 months from federal ITA to decision.
---- ELIGIBILITY ----
...
When you receive an ITA, you have exactly 25 business days to submit your complete application with all supporting documents. Candidates who are not prepared - still collecting police certificates, waiting on ECAs, or chasing employer documentation - frequently miss this window. Police certificates from India, the Philippines, and Nigeria routinely take 4-8 weeks. Plan ahead. VMC prepare complete packages before clients even register in SIRS.
...
BC PNP holds Skills Immigration Registration System (SIRS) draws weekly on Tuesdays. SIRS cutoff reached a historic low of 89 in 2026 - the most accessible it has been in years.

SIRS 89-99

2026 - historic low

Current range. Achievable with a qualifying BC job offer.

SIRS 100-106

2025 range

Mid-range. Job offer + strong language combo.

SIRS 107-116

2024 range

Historical range. Wage and NOC code are key drivers.

Health Authority

Lower cutoffs

Health Authority draws: typically 55-75 SIRS. Healthcare workers often eligible at lower scores.
...
| 95 |
| 295 |
Showing 12 most recent draws. Full BC PNP draw history available on welcomebc.ca.

How to improve your SIRS score: Your SIRS score is driven by your BC job offer wage (highest weight), NOC skill level, education, and language. Improving your hourly wage above the BC median - or switching to an occupation above the $62/hr auto-invite threshold - can move you out of the draw entirely.
...
When a BC PNP ITA arrives, you have exactly 25 business days to submit a complete application. Candidates who are unprepared miss this window and lose the invitation permanently. VMC prepare complete, submission-ready BC PNP packages before our clients receive their ITA - when the invitation arrives, we submit within days.

### Employer Eligibility Review

BC's employer eligibility requirements are strict - minimum 5 employees, no WorkSafeBC violations, CRA registration, permanent job offer. Many candidates lose their $1,750 fee because their employer didn't qualify. VMC review employer eligibility before any application is filed and works directly with BC employers on their documentation package.
...
Serving BC PNP clients in Vancouver · Surrey · Burnaby · Kelowna · Victoria · Kamloops · Prince George · and across Canada
...
| Anchor text | URL |
| --- | --- |
| Skip to main content | https://visamastercanada.com/immigration/pnp/british-columbia#main-content |
...
| Book Urgent BC PNP Assessment → | https://visamastercanada.com/book |
| Free SIRS Calculator | https://visamastercanada.com/tools/bc-pnp-calculator |
| (647) 395-3471 | tel:+16473953471 |
| → SIRS calculator | https://visamastercanada.com/tools/bc-pnp-calculator |
| → PNP hub | https://visamastercanada.com/immigration/pnp |
| → Express Entry | https://visamastercanada.com/immigration/express-entry |
| Book consult → | https://visamastercanada.com/book |
| Book BC PNP Assessment - Before Scores Rebound | https://visamastercanada.com/book |
| Calculate My SIRS Score → | https://visamastercanada.com/tools/bc-pnp-calculator |
| Book Free Consult → | https://visamastercanada.com/free-assessment |
| /tools | https://visamastercanada.com/tools |
| View All BC PNP Draws → | https://visamastercanada.com/pnp-draws?province=bc |
| Calculate my SIRS score → | https://visamastercanada.com/immigration/pnp/british-columbia#calculator |
| Book Free Assessment → | https://visamastercanada.com/book |
| 📞 (647) 395-3471 | tel:+16473953471 |
| Book Free Consultation | https://visamastercanada.com/contact |
| Book Free BC PNP Assessment | https://visamastercanada.com/book |
| Calculate My SIRS Score | https://visamastercanada.com/tools |
| PNP Hub → | https://visamastercanada.com/immigration/pnp |
| Express Entry → | https://visamastercanada.com/immigration/express-entry |
...
| Family Sponsorship → | https://visamastercanada.com/immigration/sponsorship/spousal |
...
```json
{"@context":"https://schema.org","@graph":[{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://visamastercanada.com/"},{"@type":"ListItem","position":2,"name":"Immigration","item":"https://visamastercanada.com/immigration"},{"@type":"ListItem","position":3,"name":"PNP","item":"https://visamastercanada.com/immigration/pnp"},{"@type":"ListItem","position":4,"name":"British Columbia","item":"https://visamastercanada.com/immigration/pnp/british-columbia"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do I need to already be in BC to apply to the BC PNP?","acceptedAnswer":{"@type":"Answer","text":"No - you do not need to be physically in BC or in Canada to register in the SIRS pool. However, you do need a valid BC job offer from an eligible BC employer. The Entry Level and Semi-Skilled (ELSS) stream is an exception - ELSS requires you to already be working for a BC employer in BC with at least 9 months of continuous employment. For all other streams, overseas applicants are eligible as long as they have a qualifying job offer."}},{"@type":"Question","name":"How does the $62/hr auto-invite work?","acceptedAnswer":{"@type":"Answer","text":"If your BC job offer pays $62.00 or more per hour (approximately $128,960 annually based on 40 hours/week), you receive an Invitation to Apply automatically in the next weekly draw - without competing against other SIRS candidates on score. Occupations commonly exceeding this threshold include senior software engineers, surgeons, anesthesiologists, specialist physicians, senior investment professionals, and VP/Director-level roles. The $62/hr threshold has not changed since it was introduced."}},{"@type":"Question","name":"Can my family members be included in my BC PNP application?","acceptedAnswer":{"@type":"Answer","text":"Yes. Your spouse or common-law partner and all dependent children (under 22, unmarried, not financially independent) can be included in your provincial nomination and subsequent PR application. Your spouse will receive an Open Work Permit and your children can attend Canadian schools once your PR application is in process. The $1,750 fee covers the principal applicant only - there is no additional provincial fee for family members."}},{"@type":"Question","name":"What is the BC PNP application fee and is it refundable?","acceptedAnswer":{"@type":"Answer","text":"The BC PNP application fee is $1,750 CAD, paid when you submit your full application after receiving an ITA. There is no fee to register in the SIRS pool. The fee is non-refundable under all circumstances - including if your application is returned as incomplete, withdrawn, or refused. We strongly advises having all documents ready before registering in SIRS."}},{"@type":"Question","name":"What score do I need to receive an ITA in 2026?","acceptedAnswer":{"@type":"Answer","text":"As of March 2026, the cutoff sits at 89 out of 200. This has fallen dramatically from 150 in May 2025. The cutoff fluctuates weekly based on the volume and quality of candidates in the pool. Candidates earning $62/hr or more bypass scoring entirely. Our team's free SIRS Calculator at /tools calculates your exact score across all five factors in under 2 minutes."}},{"@type":"Question","name":"What if my SIRS score is below the current cutoff?","acceptedAnswer":{"@type":"Answer","text":"You have several options. First, improve your language score - CLB 9+ earns the maximum 40 language points vs 30 for CLB 7, adding 10 points to your score. Second, check whether your employer has a location outside Metro Vancouver - the 25-point location bonus could push you over the cutoff. Third, discuss a wage increase with your employer. Fourth, consider whether federal Express Entry might give you a better outcome if you already have a competitive CRS score."}},{"@type":"Question","name":"What happened to the BC International Graduate streams?","acceptedAnswer":{"@type":"Answer","text":"BC suspended both the International Graduate and International Post-Graduate streams effective April 8, 2025. No reactivation date has been announced. BC cited the need to focus on workers already integrated into BC's workforce. If you hold a BC post-secondary credential and are working in BC on a PGWP, you may still qualify through the Skilled Worker stream if your employer will support a BC PNP application. STEM PhD graduates should consider federal Express Entry pathways."}},{"@type":"Question","name":"I have a BC job offer in a TEER 4 or 5 occupation. Can I still apply?","acceptedAnswer":{"@type":"Answer","text":"Only if your occupation and industry fall under the ELSS stream's eligible list: long-haul trucking, tourism and hospitality (outside Metro Vancouver), food processing, and select manufacturing roles. If your occupation is hospitality within Metro Vancouver or a TEER 4/5 role not on BC's ELSS list, you are not currently eligible for BC PNP. Consider whether your employer could train you into a TEER 3 supervisory role, which would qualify under the Skilled Worker stream."}},{"@type":"Question","name":"What is the BC PNP Entrepreneur Immigration Program?","acceptedAnswer":{"@type":"Answer","text":"The Entrepreneur Immigration stream is entirely separate from SIRS-based worker streams. It does not use SIRS points or weekly draws. It is designed for business owners wanting to start or purchase a business in BC. The Base Category requires a minimum net worth of $600,000 CAD, at least 3 years of business ownership experience, a minimum $200,000 CAD investment, and creation of at least 1 full-time job for a Canadian citizen or PR. The process typically takes 2-3 years from initial Expression of Interest to permanent residency."}},{"@type":"Question","name":"How long does BC PNP processing take?","acceptedAnswer":{"@type":"Answer","text":"After submitting your application, BC PNP processing takes approximately 2-5 months. Healthcare Professional and EEBC applications tend to be processed faster. Skills Immigration (non-EEBC) nominees then apply to IRCC for PR, adding another 12-18 months. EEBC nominees add their nomination to their federal Express Entry profile and receive a federal ITA within weeks - total PR timeline approximately 6 months from BC nomination."}},{"@type":"Question","name":"Do I need a Labour Market Impact Assessment (LMIA) for BC PNP?","acceptedAnswer":{"@type":"Answer","text":"Most BC PNP categories are LMIA-exempt at the work permit stage - BC PNP nominees receive a Provincial Nominee Work Permit Support Letter. However, your employer must provide recruitment evidence demonstrating they made good-faith efforts to hire Canadians first. If you are already in Canada on a valid work permit, your existing permit continues to authorize you to work for your BC employer while your BC PNP application is in process."}},{"@type":"Question","name":"Can my employer in another province hire me for a BC role?","acceptedAnswer":{"@type":"Answer","text":"Your employer must be a BC-based business with operations in British Columbia. If a company headquartered in Ontario has an established BC office where you will actually work, the BC office may qualify - but you must genuinely be employed at the BC location. Remote work arrangements where you work from another province for a BC-registered company generally do not qualify. BC verifies employment is genuinely in BC by cross-referencing employer filings and the physical job location."}}]},{"@type":"Service","name":"BC PNP Immigration Services","serviceType":"Immigration Consulting","provider":{"@type":"LocalBusiness","name":"Licensed Regulated Canadian Immigration Consultants","address":"83 Kennedy Rd S Unit 16, Brampton, Ontario","telephone":"+16473953471"},"areaServed":"British Columbia, Canada","description":"Licensed RCIC guidance for BC PNP - SIRS scoring, Skills Immigration, Express Entry BC, employer eligibility, and complete application packages."}]}
```

...
- ## What is the Intra-Company Transfer Stream?
- ### No LMIA Required
- ### Same Corporate Group
- ### Three Qualifying Categories
- ### 1-Year Qualifying Period
- ### $230 Employer Portal Fee
...
- ## The Corporate Group Requirement
- ### Parent Company
- ### Subsidiary
- ### Affiliate
- ### Branch
- ### Evidence Required to Prove the Corporate Relationship
- ## How Long is an ICT Work Permit?
- ### The 1-Year Qualifying Requirement Before Transfer
- ## What Documents Does an ICT Application Need?
- ### Employer Documents
- #### Support Letter (most critical document)
- #### Corporate Relationship Documents
- #### Canadian Entity Active Operations Evidence
- ### Worker Documents
...
- → LMIA-Exempt for Employers
- → Global Talent Stream
- → Employer Compliance
- → Express Entry (for workers)
...
The Intra-Company Transfer (ICT) is an LMIA-exempt work permit stream under IRPR R205(a) - Significant Benefit to Canada. It allows multinational companies to temporarily transfer key employees from a foreign office to a qualifying Canadian entity.
...
- ✓ Vice President (organization-wide authority)
- ✓ Managing Director
- ✓ Board-level executives

#### Key Evidence Required

- ✓ Org chart showing position at top of hierarchy
- ✓ Evidence of authority over major decisions
- ✓ Limited supervisory accountability for daily tasks
- ✓ Employment history in same capacity abroad
...
- ✓ Supervises other managers, not just front-line workers
- ✓ Authority over hiring, firing, and performance management
- ✓ Manages a department, division, or geographic market
- ✓ Involved in major operational or strategic decisions
- ✓ Receives only general supervision from above

#### Common Issues

- ⚠ Role must supervise managers, not just front-line staff
- ⚠ Must have genuine budget/hiring authority
- ⚠ Small Canadian team may raise doubts about senior management need
- ⚠ Title alone is insufficient - duties must demonstrate level
...
- ✓ Proprietary software/system developed by employer
- ✓ Unique manufacturing processes specific to company
- ✓ Specialized R&D knowledge on employer's products
- ✓ Internal methodologies not taught elsewhere

#### What Does NOT Qualify

- ✗ General industry expertise (e.g. "knows Java")
- ✗ Skills widely available in Canadian labour market
- ✗ Professional credentials alone (engineering degree)
- ✗ Years of experience without employer-specific element

#### Documentation Critical

- • Detailed description of what the knowledge is
- • How and when it was acquired at this employer
- • Why it cannot be obtained from a Canadian worker
- • Why it is essential to the Canadian entity
...
| 7 years |
| Must leave Canada; eligible for new ICT after significant period abroad |
| Specialized Knowledge Worker |
| Up to 1 year |
| Extendable in increments |
| 5 years |
| Must leave Canada; eligible for new ICT after significant period abroad |
| New Canadian Entity (any category) |
...
- Company letterhead with Canadian employer details
- Description of the qualifying corporate relationship with foreign entity
- Detailed job description of the Canadian role (duties, responsibilities, authority level)
- Evidence that role meets executive, manager, or SKW criteria
- Proof of 1-year qualifying employment abroad (dates, role, duties)
- IRCC Employer Portal A-number from offer submission
- Signed by authorized officer

#### Corporate Relationship Documents

- Certificates of incorporation for both foreign and Canadian entities
- Shareholder register or ownership documents
- Organizational chart showing both companies and their relationship
- Annual reports or financial statements showing ownership structure

#### Canadian Entity Active Operations Evidence

- Lease agreement or proof of office space in Canada
- CRA business number and tax registration
- Canadian payroll records or banking evidence
- List of Canadian employees (if any)

### Worker Documents

#### Identity and Status Documents

- Valid passport (all pages, including any previous visas)
- Two passport-size photographs meeting IRCC specifications
- Biometrics (if required - most nationals ages 14-79)
- Current immigration status documents (if already in Canada)

#### Evidence of 1-Year Qualifying Employment

- Employment letter from foreign employer confirming role, dates, and duties
- Pay stubs or payroll records covering the qualifying year
- T4 equivalents, W2s, or foreign payroll tax records
- Employment contract showing title and responsibilities

#### Credentials and Qualifications

- Educational credentials (degree/diploma relevant to the role)
...
| US L-1 |
| Legal basis |
| IRPR R205(a) - Intra-Company Transfer |
| US Immigration and Nationality Act §101(a)(15)(L) |
| Qualifying categories |
| Executive, Senior Manager, Specialized Knowledge |
| Executive, Manager, Specialized Knowledge (L-1A / L-1B) |
| 1-year requirement |
| 1 year in past 3 years |
| 1 year in past 3 years |
| Permit duration |
| Exec/Mgr: 3 yrs initial; SKW: 1 yr initial |
| L-1A: 3 yrs initial; L-1B: 3 yrs initial |
| Maximum stay |
| 7 yrs (Exec/Mgr); 5 yrs (SKW) |
| 7 yrs (L-1A); 5 yrs (L-1B) |
| Path to PR |
| CEC after 12 months → Express Entry |
| EB-1C (L-1A → EB-1C petition possible) |
| Spouse work rights |
| Spousal OWP (open, any employer) |
| EAD for spouses (H-4 EAD, policy-dependent) |
...
- What is the difference between a senior manager and a specialized knowledge worker under ICT?
- Can a startup use the Intra-Company Transfer stream?
- How long can an ICT holder stay in Canada?
- Does an ICT work permit give CRS points under Express Entry?
- Can I extend my ICT work permit?
- Can the spouse of an ICT holder work in Canada?

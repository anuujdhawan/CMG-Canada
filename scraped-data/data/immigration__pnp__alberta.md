# Alberta PNP (AAIP) 2026 | Streams, Express Entry & Points Grid | Licensed RCIC

> **Source URL:** https://visamastercanada.com/immigration/pnp/alberta
...
- **Title tag:** Alberta PNP (AAIP) 2026 | Streams, Express Entry & Points Grid | Licensed RCIC
- **Meta description:** AAIP 2026 - Alberta's 6,403 PNP spaces. AOS EOI min 56, Healthcare min 45, Accelerated Tech min 59. All streams, EOI grid and draw data by licensed RCIC.
- **Meta keywords:** (none)
- **Canonical URL:** https://visamastercanada.com/immigration/pnp/alberta
- **OG title:** Alberta PNP (AAIP) 2026 - Complete Guide | Opportunity Stream, Express Entry, Healthcare & Rural | Licensed RCIC
- **OG description:** AAIP 2026 - Alberta's 6,403 PNP spaces. AOS EOI min 56, Healthcare min 45, Accelerated Tech min 59. All streams, EOI grid and draw data by licensed RCIC.
- **Robots:** index, follow
...
- ## Alberta AAIP Points Calculator
...
Here is the arithmetic every Alberta candidate should know: the province has issued just 822 of its 6,403 nomination spaces for 2026, which means roughly 5,581 are still on the table. Draws run multiple times a month across the Alberta Opportunity Stream, Express Entry pathways, healthcare, and rural streams — and the minimum EOI scores keep landing well below what most people expect. For workers already living and working in Alberta on a valid permit, the Alberta Advantage Immigration Program (AAIP) is one of the most realistic PNP routes in Canada right now. VMC's licensed RCICs confirm your stream and employer before you submit anything.
...
Confirm your stream and employer before you submit a Worker EOI.
...
Estimate your Alberta Advantage Immigration Program EOI score. Takes 3 minutes.
...
The Alberta Express Entry Stream invites candidates from the federal Express Entry pool through targeted selection draws. An AEES nomination adds 600 CRS points to your federal Express Entry profile — in recent draws, well above every published cutoff regardless of your base CRS score. Federal PR timeline after nomination: approximately 6 months.
...
| T&H sector workers in Alberta |
| 73 |
| 68 |
| Feb 20, 2026 |
| Alberta Opportunity Stream - Priority Sectors |
| In-Alberta workers (priority sectors) |
| 56 |
| 831 |
| Feb 19, 2026 |
...
| 32 |
| Feb 11, 2026 |
| Alberta Express Entry Stream - Accelerated Tech |
...
| 212 |
| Feb 6, 2026 |
| Alberta Express Entry Stream - Law Enforcement |
| Police (AACP-identified) |
| 50 |
| <10 |
| Feb 2, 2026 |
| Alberta Opportunity Stream |
| In-Alberta workers (general) |
| 57 |
| 915 |
| Jan 29, 2026 |
| Alberta Express Entry Stream - Accelerated Tech |
...
| 148 |
| Jan 27, 2026 |
| Dedicated Health Care Pathway - Non-EE |
| Healthcare workers (no EE profile) |
| 45 |
| 43 |
| Jan 26, 2026 |
| Dedicated Health Care Pathway - Express Entry |
| Healthcare workers (EE profile) |
| 61 |
| 63 |
| Nov 10, 2025 |
| Alberta Opportunity Stream |
...
| 1,113 |
| Sep 3, 2025 |
| Dedicated Health Care - Non-EE |
| Healthcare |
| 44 |
| 67 |
| Oct 24, 2025 |
| AEES - Priority Sectors (Health Care) |
| Healthcare EE |
| 42 |
| 142 |
...
- ✓ OR (if smaller): is limited in the number of nominees they can support, based on years of operation: - 2 years of operation: maximum 1 nominee total
...
Alberta declines applications where employer requirements are not met - and the $1,500 application fee is non-refundable. VMC review employer eligibility as part of every AAIP consultation before any EOI is submitted. If your employer has been operating less than 2 years, does not meet the revenue threshold, or their business structure disqualifies them, we identify this before you invest time and money in an application that will be refused.
...
We provide comprehensive AAIP strategy across all four worker streams and their pathways: Alberta Opportunity Stream, Alberta Express Entry Stream (Dedicated Healthcare, Accelerated Tech, Law Enforcement, Priority Sectors), Dedicated Healthcare Pathway (non-EE), Rural Renewal Stream, and Tourism and Hospitality Stream. In a single free assessment, VMC confirms your stream, reviews employer eligibility, calculates your EOI profile strength, and maps your complete Alberta PR pathway including post-nomination federal steps.
...
Serving Alberta PNP clients in Calgary · Edmonton · Red Deer · Lethbridge · Fort McMurray · Grande Prairie · Medicine Hat · Lloydminster · Camrose · and across Canada
...
| Anchor text | URL |
| --- | --- |
| Skip to main content | https://visamastercanada.com/immigration/pnp/alberta#main-content |
...
| Book Your AAIP Assessment → | https://visamastercanada.com/free-assessment |
| Free AAIP Calculator | https://visamastercanada.com/tools/alberta-pnp-calculator |
...
| Calculate My AAIP Score → | https://visamastercanada.com/tools/alberta-pnp-calculator |
| Book Free Consult → | https://visamastercanada.com/free-assessment |
| aaip.labour.alberta.ca | https://aaip.labour.alberta.ca/ |
| alberta.ca | https://www.alberta.ca/ |
| alberta.ca/aaip-processing-information | https://www.alberta.ca/aaip-processing-information |
| Book Free AAIP Assessment → | https://visamastercanada.com/free-assessment |
| 📞 (647) 395-3471 | tel:+16473953471 |
...
| BC PNP → | https://visamastercanada.com/immigration/pnp/british-columbia |
...
```json
{"@context":"https://schema.org","@graph":[{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://visamastercanada.com/"},{"@type":"ListItem","position":2,"name":"Immigration","item":"https://visamastercanada.com/immigration"},{"@type":"ListItem","position":3,"name":"Provincial Nominee Program","item":"https://visamastercanada.com/immigration/pnp"},{"@type":"ListItem","position":4,"name":"Alberta","item":"https://visamastercanada.com/immigration/pnp/alberta"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the Alberta Advantage Immigration Program (AAIP)?","acceptedAnswer":{"@type":"Answer","text":"The AAIP is Alberta's provincial nominee program. Alberta nominates skilled workers and entrepreneurs for Canadian permanent residence. The program is run jointly by Alberta and the Government of Canada - Alberta assesses applications and issues nominations, and IRCC makes final decisions on permanent residence. AAIP has four worker streams: the Alberta Opportunity Stream, the Alberta Express Entry Stream (with dedicated pathways for healthcare, technology, law enforcement, and priority sectors), the Rural Renewal Stream, and the Tourism and Hospitality Stream. An AAIP nomination adds 600 CRS points for Express Entry-linked streams, making federal PR near-certain at the next draw."}},{"@type":"Question","name":"How many AAIP spaces remain in 2026?","acceptedAnswer":{"@type":"Answer","text":"As of March 4, 2026, Alberta has issued 822 of its 6,403 total nomination spaces - leaving 5,581 spaces available. Remaining by stream: Alberta Opportunity Stream: 2,861 remaining. Rural Renewal Stream: 987 remaining. Dedicated Health Care Pathway: 444 remaining. Accelerated Tech Pathway: 525 remaining. Priority Sectors: 521 remaining. Tourism and Hospitality Stream: 118 remaining. Additionally, physicians (NOC 31100-31102) and Francophones meeting eligibility criteria can access a separate federal initiative pool of up to 10,000 additional spaces nationally - those nominations do not count against the 6,403 standard allocation."}},{"@type":"Question","name":"Can I submit an EOI if I don't have an Alberta job offer?","acceptedAnswer":{"@type":"Answer","text":"Yes - you can submit an EOI without a job offer. However, having a qualifying Alberta job offer contributes significant points to your EOI score and is required to actually qualify for most streams when invited to apply. Without a job offer, you would need to secure one between receiving your invitation and submitting your application - which is extremely challenging within the 30-day application window. We strongly advises securing your Alberta job offer before or during the EOI submission process."}},{"@type":"Question","name":"My work permit is being renewed (maintained status). Can I apply to the AOS?","acceptedAnswer":{"@type":"Answer","text":"No. The Alberta Opportunity Stream explicitly requires a valid work permit - not maintained/implied status - at both the time of application submission and at the time AAIP assesses your application. The only AAIP stream that accepts maintained status is the Dedicated Health Care Pathway (non-Express Entry option). If your permit is under renewal and you receive an AOS invitation, timing is critical - your application assessment must occur while you hold a valid permit, not just at submission. VMC advises clients on permit renewal timing to avoid this common disqualification."}},{"@type":"Question","name":"I have a PGWP from the University of Toronto. Can I use it for the AOS?","acceptedAnswer":{"@type":"Answer","text":"No. The AOS only accepts PGWPs from Alberta Advanced Education publicly funded post-secondary institutions. A PGWP from any institution outside Alberta does not qualify for the AOS. Your AAIP options with a non-Alberta PGWP include: the Alberta Express Entry Stream (if you have an active EE profile with CRS 300+), the Rural Renewal Stream (if you have a job offer in a designated rural community and community endorsement), or the Dedicated Health Care Pathway (if you are one of the 9 eligible healthcare professionals). contact us for an assessment of your specific situation."}},{"@type":"Question","name":"What occupations are ineligible for the AOS?","acceptedAnswer":{"@type":"Answer","text":"Alberta maintains a specific list of occupations that are not eligible for the AOS. The list includes: legislators (00010), school principals (40021), social services managers (40030), fire chiefs (40041), judges (41100), elementary and secondary school teachers (41220, 41221), authors (51111), musicians and singers (51122), real estate agents (63101), home child care providers (44100), home support workers and caregivers (44101), casino occupations (64321), harvesting labourers (85101), and others. Early childhood educators (42202) are only eligible at Level 2 or Level 3 certification - Level 1 ECEs are ineligible. Always verify your specific NOC code against the current AAIP ineligible occupation list at alberta.ca before submitting an EOI."}},{"@type":"Question","name":"What are the 9 eligible healthcare professions under the Dedicated Health Care Pathway?","acceptedAnswer":{"@type":"Answer","text":"The Dedicated Health Care Pathway - both the Express Entry and Non-Express Entry options - covers exactly 9 eligible healthcare professions: (1) Physicians (CPSA), (2) Registered Nurses (CRNA), (3) Licensed Practical Nurses (CLPNA), (4) Nurse Practitioners (CRNA), (5) Physician Assistants (CPSA), (6) Occupational Therapists (ACOT), (7) Physiotherapists (CPA), (8) Clinical Social Workers (ACSW), and (9) Psychologists (CAP). You must provide verifiable proof of meeting the minimal requirements prescribed by the applicable regulatory body to practice your eligible profession in Alberta. Other healthcare workers - medical lab technologists, pharmacists, dental hygienists, etc. - do not qualify under the Dedicated Health Care Pathway and must apply through the AOS or AEES Priority Sectors draws."}},{"@type":"Question","name":"I'm a healthcare worker without an Express Entry profile. Can I still access AAIP?","acceptedAnswer":{"@type":"Answer","text":"Yes - and this is one of the most powerful immigration pathways currently available in Alberta. The Dedicated Health Care Pathway has a Non-Express Entry option specifically for healthcare workers who cannot create or do not qualify for a federal Express Entry profile. Minimum EOI score has been as low as 44 in 2025-2026 draws. The non-EE option accepts maintained/implied status (unlike the AOS). After nomination through the non-EE pathway, you apply directly to IRCC for PR - federal processing takes approximately 12-18 months. VMC advises all non-EE healthcare clients to simultaneously explore whether they qualify to create an EE profile, as the EE-linked pathway offers faster PR (approximately 6 months)."}},{"@type":"Question","name":"How does the Rural Renewal Stream Endorsement of Candidate letter work?","acceptedAnswer":{"@type":"Answer","text":"The Endorsement of Candidate letter is issued by the Economic Development Organization (EDO) of your specific designated Alberta community. There are two ways to receive one: the community directly recruits and endorses you (some communities proactively recruit workers for specific positions), or you receive an AAIP invitation through the EOI pool and then work with your employer and the local EDO to obtain the endorsement letter. The letter is valid for only one year from the date of issuance. It must include: specific job details, how the position aligns with the community's economic growth, employer recruitment efforts to hire Canadians first, and EDO contact details. The endorsement is required at time of EOI submission for Rural Renewal - you cannot enter the Rural Renewal pool without it."}},{"@type":"Question","name":"After I receive my AAIP invitation, exactly how much time do I have?","acceptedAnswer":{"@type":"Answer","text":"AAIP's application timeline has two components: (1) You have 15 days from the date you receive the invitation email to START the application by clicking the unique application link. (2) Once you have started the application, you have 30 days from the start date to SUBMIT the completed application. After submitting, you have 24 hours to pay the $1,500 application fee online. Missing any of these deadlines results in application cancellation - which is non-reversible and non-refundable. We prepare complete application packages before clients submit their EOI so that when the invitation arrives, starting and submitting can happen within days. Do not click the invitation link until you are fully prepared to complete and submit the application."}},{"@type":"Question","name":"What happens if my AAIP application is declined?","acceptedAnswer":{"@type":"Answer","text":"You receive an email with reasons for decline. If you believe an error was made in applying program criteria to your application, you may submit one request for reconsideration within 30 calendar days of the decision letter. The reconsideration fee is $250 - automatically refunded only if the decision is overturned. Reconsideration requests cannot be used to submit new evidence, request exceptions to criteria, or appeal policy decisions. If the reconsideration is unsuccessful, you may review your eligibility for other streams or re-apply after addressing the reasons for decline. We recommends contacting an RCIC immediately after any AAIP decline to assess options before the 30-day reconsideration window closes."}},{"@type":"Question","name":"Can I apply to AAIP from outside Alberta or outside Canada?","acceptedAnswer":{"@type":"Answer","text":"For most worker streams, you must be living and working in Alberta with a valid work permit (AOS, THS). Exceptions: The Rural Renewal Stream accepts applicants from outside Alberta and from outside Canada, provided they have a job offer in a designated community and a valid Endorsement of Candidate letter (with TEER 0-3 occupations for those outside Alberta). The Alberta Express Entry Stream can invite candidates from outside Alberta through priority sector and healthcare draws, particularly where a job offer in the priority sector occupation is provided. The Dedicated Health Care Pathway (non-EE) accepts candidates working in Alberta at the time of application - including those on maintained status."}}]},{"@type":"Service","name":"Alberta AAIP Immigration Services","serviceType":"Immigration Consulting","provider":{"@type":"LocalBusiness","name":"Licensed Regulated Canadian Immigration Consultants","address":"83 Kennedy Rd S Unit 16, Brampton, Ontario","telephone":"+16473953471"},"areaServed":"Alberta, Canada","description":"Licensed RCIC guidance for Alberta AAIP - Alberta Opportunity Stream, Express Entry pathways, Dedicated Health Care, Rural Renewal, Tourism and Hospitality, and employer eligibility review."}]}
```

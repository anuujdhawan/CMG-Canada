# Nova Scotia PNP (NSNP) 2026 | Streams, AIP & Healthcare | Licensed RCIC

> **Source URL:** https://visamastercanada.com/immigration/pnp/nova-scotia
...
- **Title tag:** Nova Scotia PNP (NSNP) 2026 | Streams, AIP & Healthcare | Licensed RCIC
- **Meta description:** Nova Scotia Nominee Program 2026 - four streams effective Feb 18: Skilled Worker, NS Graduate, Entrepreneur and NS Express Entry. AIP available. Expert RCIC.
- **Meta keywords:** (none)
- **Canonical URL:** https://visamastercanada.com/immigration/pnp/nova-scotia
- **OG title:** Nova Scotia PNP (NSNP) 2026 - Complete Guide | 4 Consolidated Streams, AIP, Construction & Healthcare | Licensed RCIC
- **OG description:** Nova Scotia Nominee Program 2026 - four streams effective Feb 18: Skilled Worker, NS Graduate, Entrepreneur and NS Express Entry. AIP available. Expert RCIC.
- **Robots:** index, follow
...
- → PEI
- → Newfoundland
Confirm NAICS before EOI

Hospitality pause is employer-sector based.
...
As of April 17, 2024, the Nova Scotia Nominee Program paused intake of new Expressions of Interest from the Accommodation and Food Services sector (NAICS 72). That pause remains in effect as of March 2026.

In addition, the Atlantic Immigration Program (AIP) and the former Nova Scotia Experience: Express Entry stream have also paused applications involving NOC 62020 (food service supervisors). Candidates employed in accommodation and food service occupations with an employer outside NAICS 72 may still apply to NSNP streams — confirming it is the employer's sector classification, not the candidate's job title alone, that determines eligibility. If you work in hospitality and your employer is classified outside NAICS 72, contact us immediately to confirm your eligibility. If your employer is NAICS 72, alternative pathways must be identified.

The Nova Scotia Nominee Program (NSNP) is Nova Scotia's provincial economic immigration program, operated by the Department of Labour, Skills and Immigration. Through the NSNP, prospective immigrants with skills and experience needed by Nova Scotia employers may be nominated to immigrate to Canada permanently. Like all provincial nominee programs, the NSNP issues provincial nominations — final decisions on permanent residence applications are made by [Immigration, Refugees and Citizenship Canada (IRCC)](https://www.canada.ca/en/immigration-refugees-citizenship.html). After receiving a nominee certificate, applicants have 12 months to apply to IRCC for permanent residence. You, your spouse, and your dependants must meet all federal requirements for medical, security, and criminal admissibility.

Nova Scotia also participates in the Atlantic Immigration Program (AIP) — a federal program that allows designated Nova Scotia employers to hire skilled foreign workers and international graduates for positions they have been unable to fill locally. The AIP is administered federally by IRCC but requires provincial endorsement. Unlike the NSNP (a nomination program), the AIP lets endorsed foreign workers apply directly to IRCC for permanent residence. The AIP and the NSNP operate independently and serve different employer needs.
...
| --- | --- | --- |
| Nova Scotia Demand: Express Entry | → | Nova Scotia: Express Entry |
| Nova Scotia Experience: Express Entry | → | Nova Scotia: Express Entry |
| Labour Market Priorities | → | Nova Scotia: Express Entry |
| Labour Market Priorities for Physicians | → | Nova Scotia: Express Entry |
| Critical Construction Worker Pilot | → | Skilled Worker (Construction sub-criteria) |
| Physician Stream | → | Skilled Worker (Physician sub-criteria) AND NS: Express Entry (Physician sub-criteria) |
| International Graduate Entrepreneur Stream | → | Entrepreneur (International Graduates sub-criteria) |
| International Graduates in Demand | → | Nova Scotia Graduate |
...
| Code | Program | Employer / sector | Job offer | Language | Age |
| --- | --- | --- | --- | --- | --- |
| 1A | Skilled Worker (General) | Any eligible NS employer | Full-time permanent | CLB 5 (TEER 0-3); CLB 4 + test (TEER 4-5) | 21-55 |
| 1B | Construction | NAICS 23 · 22 NOCs | Full-time permanent | Test always (CLB 5 / 4) | 21-55 |
| 1C | Physicians | NSHA / IWK only | Per approved opportunity | As required | 21-55 |
| 1D | Occupations in Demand | Provincial list (check live list) | When occupation listed | CLB 4 | 21-55 |
...
| Step | What happens |
| --- | --- |
| 1 | Employer designation: Business in good standing, labour need shown, settlement support pledged, mandatory onboarding and intercultural training completed. |
| 2 | Position endorsement: Per role and candidate — unsuccessful local recruitment, full-time non-seasonal offer co-signed with the worker, individualized settlement plan co-signed with the worker. |
| 3 | Federal PR application: Endorsed worker applies to IRCC with the valid provincial endorsement certificate. |
...
Business portal: [accesstobusiness.snsmr.gov.ns.ca](https://accesstobusiness.snsmr.gov.ns.ca/)

As of November 28, 2025, Nova Scotia formalized an Expression of Interest (EOI) process across all NSNP streams. Submitting an EOI does not guarantee an invitation to apply — Nova Scotia selects candidates from the EOI pool based on labour market needs, available nomination spaces, and applicant eligibility. The EOI portal is available at [novascotia.ca/eNSNP](https://novascotia.ca/eNSNP).
...
Nova Scotia's consolidation from 10 streams to 4 means the stream name you applied under before February 18, 2026 may no longer exist as a standalone option. We re-assess every Nova Scotia client under the current four-stream structure to confirm which sub-criteria they qualify for and to ensure no eligibility has been lost or gained in the transition.

### Employer NAICS Verification - Before Any EOI Is Filed

The Accommodation and Food Services pause is based on employer NAICS classification. We confirm your employer's NAICS code before any Nova Scotia application is filed. If your employer is NAICS 72, we identify alternative pathways — Atlantic Immigration Program (where the employer may qualify for designation), federal Express Entry, or other provincial programs — and map your complete Canadian PR strategy.

### Healthcare and Physician Pathways - Two Streams, One Expert Team

Nova Scotia's physician recruitment operates through both the Skilled Worker Physician sub-criteria and the Express Entry Physician sub-criteria. We guide physicians through the approved opportunity process with NSHA/IWK, the Return for Service Agreement review (for EE physicians), and the 30-day Express Entry submission window. For other healthcare workers, we identify the correct NSNP stream (Graduate or Skilled Worker) and confirm regulatory certification requirements with the applicable Nova Scotia body.

### Express Entry + NSNP = Fastest Nova Scotia PR

An NSNP nomination under the Nova Scotia: Express Entry stream adds 600 CRS points, making federal PR achievable in approximately 6 months after nomination. We assess every NS Express Entry candidate's eligibility — confirming 1 year of Nova Scotia work experience, NOC TEER classification, and language requirement — before any application is filed. For PGWP holders specifically: we confirm whether the institution attended qualifies as a Nova Scotia DLI before building an Express Entry strategy around NS experience.

### Licensed RCICs - CICC-Regulated Representation

We are regulated by the [College of Immigration and Citizenship Consultants (CICC)](https://college-ic.ca/). Principal Consultant Sanjay Singh Kumar (RCIC R705959) provides licensed NSNP and AIP guidance. Nova Scotia explicitly cautions applicants to use only registered representatives — lawyers in good standing with a Canadian provincial law society or RCIC licensed by IRCC. Every VMC Nova Scotia client is represented by a licensed professional who understands both the NSNP and AIP in their current 2026 configuration.

### Four streams - confirm yours before the EOI

We verify employer NAICS, stream fit, and whether NSNP or AIP is your fastest path to PR.
...
Our team's licensed RCICs confirm your stream and sub-criteria under Nova Scotia's February 2026 consolidation, verify employer NAICS and job offer eligibility, and map the fastest route to permanent residence — whether NSNP nomination or Atlantic Immigration Program endorsement. Always cross-check [IRCC's provincial nominee page](https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/provincial-nominees.html) and the [official Nova Scotia immigration website](https://novascotia.ca/immigration/) for current rules.
...
| Anchor text | URL |
| --- | --- |
| Skip to main content | https://visamastercanada.com/immigration/pnp/nova-scotia#main-content |
...
| Book Your NSNP Assessment → | https://visamastercanada.com/free-assessment |
| Check My Stream | https://visamastercanada.com/free-assessment |
...
| → Newfoundland | https://visamastercanada.com/immigration/pnp/newfoundland |
| Book consult → | https://visamastercanada.com/free-assessment |
| Get My Nova Scotia Eligibility Confirmed → | https://visamastercanada.com/free-assessment |
| accesstobusiness.snsmr.gov.ns.ca | https://accesstobusiness.snsmr.gov.ns.ca/ |
| novascotia.ca/eNSNP | https://novascotia.ca/eNSNP |
| Book Free NSNP Assessment → | https://visamastercanada.com/free-assessment |
| 📞 (647) 395-3471 | tel:+16473953471 |
...
| New Brunswick → Atlantic Canada | https://visamastercanada.com/immigration/pnp/new-brunswick |
...
```json
{"@context":"https://schema.org","@graph":[{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://visamastercanada.com/"},{"@type":"ListItem","position":2,"name":"Immigration","item":"https://visamastercanada.com/immigration"},{"@type":"ListItem","position":3,"name":"Provincial Programs","item":"https://visamastercanada.com/immigration/pnp"},{"@type":"ListItem","position":4,"name":"Nova Scotia NSNP","item":"https://visamastercanada.com/immigration/pnp/nova-scotia"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What happened to the Nova Scotia Nominee Program's 10 streams?","acceptedAnswer":{"@type":"Answer","text":"On February 18, 2026, Nova Scotia consolidated its 10 separate immigration streams into 4 streams: Skilled Worker, Nova Scotia Graduate, Entrepreneur, and Nova Scotia: Express Entry. The underlying eligibility requirements did not change - the sub-criteria within each new stream mirror the requirements of the former individual streams exactly. The former Critical Construction Worker Pilot is now the Construction sub-criteria under Skilled Worker. The former International Graduate Entrepreneur Stream is now the International Graduates sub-criteria under Entrepreneur. The former Nova Scotia Experience: Express Entry, Labour Market Priorities, and Labour Market Priorities for Physicians streams are all consolidated under Nova Scotia: Express Entry. EOI submissions already in the NSNP pool before February 18, 2026 were not affected - they remain active."}},{"@type":"Question","name":"Is the Accommodation and Food Services sector still paused?","acceptedAnswer":{"@type":"Answer","text":"Yes. As of March 2026, the NSNP pause on Accommodation and Food Services (NAICS 72) employer EOI submissions remains in effect. This pause has been in place since April 17, 2024. The AIP pause on NOC 62020 (food service supervisors) also remains. Nova Scotia has not announced a reopening date. Workers employed in accommodation/food service occupations with employers classified outside NAICS 72 may still be eligible - the employer's sector classification determines this. If you work in food service for a healthcare facility, school, or corporate cafeteria company not classified under NAICS 72, your employer may not be subject to the pause. We confirms employer NAICS classification in every initial consultation."}},{"@type":"Question","name":"Why does the Construction sub-criteria require a language test even for native English speakers?","acceptedAnswer":{"@type":"Answer","text":"The general Skilled Worker sub-criteria exempts first-language English or French speakers from providing a language test for TEER 0-3 positions. However, the Construction sub-criteria removed this exemption - test results are required even if English or French is your first language. Nova Scotia implemented this change to ensure all construction workers can demonstrate minimum language ability because language proficiency is critical for workplace safety in construction environments. The required level is CLB 5 for TEER 0-3 and CLB 4 for TEER 4-5. Book an IELTS General Training test before submitting your Construction EOI regardless of your native language."}},{"@type":"Question","name":"I work in the construction sector but my job is not on the 22 eligible NOC list. Can I still apply?","acceptedAnswer":{"@type":"Answer","text":"You may be able to apply under the general Skilled Worker sub-criteria rather than the Construction sub-criteria - as long as your position is a full-time permanent job offer from a Nova Scotia employer and you meet all general Skilled Worker requirements. The Construction sub-criteria is specifically for workers whose positions fall under one of 22 designated construction NOCs with a NAICS 23 employer. Workers in construction-related roles not on the list (e.g., project managers in non-NAICS-23 companies, construction accountants, or related professionals) may qualify under the general Skilled Worker sub-criteria. We determines the correct sub-criteria in every initial assessment."}},{"@type":"Question","name":"I graduated from Dalhousie University in Halifax and have a PGWP. I'm working in Nova Scotia. Which NSNP stream can I use?","acceptedAnswer":{"@type":"Answer","text":"You have multiple options. For the Nova Scotia: Express Entry stream: you may be able to qualify since you graduated from a Nova Scotia institution (Dalhousie) - your NS PGWP work experience is eligible for this stream, unlike PGWP holders from non-NS institutions. For the general Skilled Worker stream: if you have a permanent full-time NS job offer, this may also be available. For the Nova Scotia Graduate stream: check whether your occupation is one of the 4 eligible NOCs (32102, 32124, 33102, 42202) - if so and your field of study matches, this may be your fastest pathway. We maps all three options for NS DLI graduates in a single consultation."}},{"@type":"Question","name":"What is the difference between the NSNP and the Atlantic Immigration Program (AIP)?","acceptedAnswer":{"@type":"Answer","text":"NSNP is a provincial nomination program: Nova Scotia nominates you → you apply to IRCC for PR using the nomination certificate. AIP is a federal direct PR program with provincial endorsement: your Nova Scotia employer becomes AIP-designated → they endorse your specific position → you apply directly to IRCC for PR using the endorsement certificate. Key differences: NSNP counts against Nova Scotia's provincial nomination allocation; AIP is a federal program and does not. NSNP nominations are issued to individuals; AIP endorsements are issued to positions (employers control the process). NSNP Express Entry nominations add +600 CRS points; AIP endorsed workers apply directly to IRCC without needing CRS points. AIP requires a two-step employer process (designation then endorsement); NSNP just requires the employer to provide a qualifying job offer."}},{"@type":"Question","name":"How does a Nova Scotia employer become AIP designated?","acceptedAnswer":{"@type":"Answer","text":"AIP designation is a one-time process for the employer organization (not per-position). To become designated, a Nova Scotia employer must: demonstrate they are a business operating in good standing, provide information on their labour needs, commit to working with a service provider organization on settlement and retention for incoming workers, and complete mandatory onboarding training and, if required, intercultural competency training. Applications for designation are submitted through Nova Scotia's online business portal (accesstobusiness.snsmr.gov.ns.ca). Once designated, the employer can then apply to endorse specific positions and candidates. Designation does not expire annually - it is maintained as long as the employer remains in compliance."}},{"@type":"Question","name":"Can an AIP worker get a work permit before their PR is processed?","acceptedAnswer":{"@type":"Answer","text":"Yes. Employers supporting AIP work permit applications must: register in the federal employer portal, submit the job offer through the federal employer portal, and pay a compliance fee. Once the employer has the endorsement certificate and the work permit referral letter from Nova Scotia, the endorsed foreign worker can apply to IRCC for a temporary work permit while their PR application is being processed. This allows workers to begin employment in Nova Scotia without waiting for PR, which can take 12-18 months."}},{"@type":"Question","name":"What is the minimum investment required for the Entrepreneur stream?","acceptedAnswer":{"@type":"Answer","text":"For businesses located within the Halifax Regional Municipality (HRM): minimum personal net worth of $600,000 CAD, with a minimum investment of $150,000 CAD of the entrepreneur's own funds to establish the business. For businesses located outside HRM (rural and non-Halifax areas): minimum net worth of $400,000 CAD, with a minimum investment of $100,000 CAD. These reduced thresholds for outside-HRM businesses reflect Nova Scotia's strategy of encouraging entrepreneurial immigration to smaller communities beyond Halifax. The net worth must be verified by one of Nova Scotia's three approved Financial Statement Review Service Providers - Doane Grant Thornton LLP (Halifax), MNP (Dartmouth), or White Perkins (Yarmouth)."}},{"@type":"Question","name":"How long must an entrepreneur operate the business before receiving a nomination?","acceptedAnswer":{"@type":"Answer","text":"After obtaining a temporary work permit and arriving in Nova Scotia to establish and operate the business, the entrepreneur typically operates for approximately 1 year, then applies for nomination. During this period, the entrepreneur must demonstrate active management of the business and performance against a Business Performance Agreement (BPA) signed at the start of the process. The NSNP monitors the business's progress against the BPA. Only after the province is satisfied that the business is operating as agreed and the entrepreneur has genuinely established themselves in Nova Scotia is the nomination issued. The overall timeline from first arriving to receiving a nomination is typically 12-24 months."}},{"@type":"Question","name":"I'm a Nova Scotia university graduate with a business I started 8 months ago. Can I apply for the International Graduate Entrepreneur sub-criteria?","acceptedAnswer":{"@type":"Answer","text":"Not yet. The International Graduate sub-criteria requires at least 1 year of continuous experience actively managing and owning your current Nova Scotia business. With 8 months of operation, you do not yet meet the 1-year threshold. Continue operating the business - once you reach 12 months, you may submit an Expression of Interest for the International Graduate Entrepreneur sub-criteria. Requirements at application: 2+ academic years of full-time in-person study at a NS university or NSCC, valid PGWP, CLB 7, 33.33% minimum ownership, genuine active management of the NS business. We can begin your pre-application preparation now so that your EOI and application are ready the moment you hit 12 months."}},{"@type":"Question","name":"Does Nova Scotia have occupation in-demand draws running right now?","acceptedAnswer":{"@type":"Answer","text":"As of March 2026, there are no occupations listed under the Skilled Worker - Occupations in Demand sub-criteria. This sub-criteria targets specific NOC TEER 3, 4, or 5 occupations that Labour, Skills and Immigration identifies as being in high labour market demand - but the list is updated based on current labour market data and may be empty for extended periods. When occupations are added, they are published on the official NSNP website. We monitor the NSNP website regularly and notifies clients when new occupations are added to the in-demand list - if your occupation is TEER 3, 4, or 5 and you want to know if it may be added, book a consultation."}}]},{"@type":"Service","name":"Nova Scotia NSNP Immigration Services","serviceType":"Immigration Consulting","provider":{"@type":"LocalBusiness","name":"Licensed Regulated Canadian Immigration Consultants","address":"83 Kennedy Rd S Unit 16, Brampton, Ontario","telephone":"+16473953471"},"areaServed":"Nova Scotia, Canada","description":"Licensed RCIC guidance for NSNP - four consolidated streams, AIP, construction and healthcare pathways, and complete application packages."}]}
```

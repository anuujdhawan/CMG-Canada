# Saskatchewan PNP (SINP) 2026 | Streams, Windows & Points Grid | Licensed RCIC

> **Source URL:** https://visamastercanada.com/immigration/pnp/saskatchewan
...
- **Title tag:** Saskatchewan PNP (SINP) 2026 | Streams, Windows & Points Grid | Licensed RCIC
- **Meta description:** Saskatchewan SINP 2026 - 4,761 spaces. Seven priority sectors open anytime. Window 3 open (May 4). 110-point EOI grid, PGWP restrictions. Licensed RCIC.
- **Meta keywords:** (none)
- **Canonical URL:** https://visamastercanada.com/immigration/pnp/saskatchewan
- **OG title:** Saskatchewan PNP (SINP) 2026 - Complete Guide | Three-Tier System, Streams, Windows & Points Grid | Licensed RCIC
- **OG description:** Saskatchewan SINP 2026 - 4,761 spaces. Seven priority sectors open anytime. Window 3 open (May 4). 110-point EOI grid, PGWP restrictions. Licensed RCIC.
- **Robots:** index, follow

## Heading Outline

- # Saskatchewan Immigrant Nominee Program (SINP) 2026
- ## ⚡ Windows 1 and 2 Are Closed - Window 3 Is Now Open (opened May 4, 2026 at 8:30 a.m. CST)
...
- ### Window 3 Is Open Now. Act Before Positions Fill.
- ## Saskatchewan's Window 3 Is Now Open. Priority Sectors Are Open Now.
...
Capped sectors fill fast - submit your JAF now while positions remain.
...
No other PNP in Canada manages immigration access this way. Priority sector workers have the best access in the program's history — open anytime, overseas eligible, no work permit timing rules. Capped sector workers face the most competitive windows in the program's history — filling within hours. Other sector workers have continuous but restricted access. VMC identifies your tier in the first consultation — before any documents are prepared.
...
Window 3 (May 4, 2026): Now open - currently accepting applications
...
Model your score with our SINP tool

Run the same eligibility and points logic we use in consults — scroll down to use the calculator below.
...
| Bachelor's OR at least 3-year degree at university or college | 20 |
| Trade certification = SK journeyperson equivalent | 20 |
...
| CLB 5 | 14 |
| CLB 4 | 12 |
| English/French speaker, no test | 0 |
...
| Window | Date | Acc/Food (180/240) | Retail (60/80) | Trucking (60/80) | Status |
| --- | --- | --- | --- | --- | --- |
| Window 1 | Jan 13, 2026 | 180/180 filled (Jan 13) | 60/60 filled (Jan 13) | 60/60 filled (Jan 20) | CLOSED |
| Window 2 | Mar 2, 2026 at 8:30 a.m. CST | 240/240 filled (Mar 2) | 80/80 filled (Mar 2) | 47/80 used | CLOSED |
| Window 3 | May 4, 2026 at 8:30 a.m. CST | TBD | TBD | TBD | OPEN |
| Window 4 | July 6, 2026 | TBD | TBD | TBD | Future |
| Window 5 | Sept 7, 2026 | TBD | TBD | TBD | Future |
| Window 6 | Nov 2, 2026 | TBD | TBD | TBD | Future |
...
In capped sector windows, the employer submits the Job Approval Form (JAF) through the SINP OASIS portal — not the candidate. The JAF requests specific positions for specific candidates. The employer must have already registered with SINP and obtained their employer registration before any JAF can be submitted. Candidates cannot submit independently — their access depends entirely on their employer's readiness and submission timing. We work directly with capped sector employers to ensure the JAF is drafted, employer registration is complete, and everything is ready for one-click submission at window opening.

### Draft the JAF Now - Submission Is Only Possible During the Window

SINP explicitly allows employers to draft their Job Approval Form (JAF) at any time in the OASIS portal — even outside an active intake window. Warning messages will appear when submitting outside a window, but drafting is always possible. This is critical: employers who have not yet drafted their JAF are already behind for Window 3. JAFs that are drafted, reviewed, and ready in advance can be submitted in under one minute. Employers who start drafting now, while Window 3 is open, may not complete submission before the cap is reached.

### 6-Month Work Permit Rule - Verify Before Window Opens

Candidates must have 6 months or less remaining on their work permit at the time the employer submits the JAF. A candidate with a work permit expiring October 1, 2026 and Window 3 open on May 4, 2026 has exactly 150 days (approximately 5 months) — they qualify. A candidate with a work permit expiring December 1, 2026 has 211 days (approximately 7 months) — they do NOT qualify for Window 3. JAFs submitted for candidates with more than 6 months remaining on their permit are closed and returned. Verify your work permit expiry date against each window date before any preparation begins.

### Missing a Window Means Waiting Months - Timeline Matters

Window 3 (May 4) to Window 4 (July 6) is a 63-day gap. For candidates approaching permit expiry, this gap can be critical. A worker whose permit expires August 31, 2026 is in the 6-month window for Window 3 but may face permit issues by September 7. For candidates whose permit will expire before the next window, it may be necessary to renew the work permit and wait for a later window, or explore alternative immigration pathways. We map every capped sector client's work permit expiry date against all six windows to identify the correct strategy.

## Saskatchewan SINP Points Calculator

Calculate your SINP International Skilled Worker score. Min 60/110 to be eligible. Takes 3 minutes.
...
| Date | Intake Type | Positions | Notes |
| --- | --- | --- | --- |
| May 4, 2026 | Capped Sector Window | 250 | Window 3 opened May 4 - capped positions |
| May 4, 2026 | Priority Sector (Open) | 840 | Priority sectors - continuous intake |
| Mar 10, 2026 | Capped Sector Window | 300 | Window 2 - closed (filled) |
| Mar 10, 2026 | Priority Sector (Open) | 760 | Priority sectors - continuous intake |
| Jan 20, 2026 | Capped Sector Window | 300 | Window 1 - closed (filled) |
| Jan 20, 2026 | Priority Sector (Open) | 820 | Priority sectors - continuous intake |
| Oct 15, 2025 | Priority Sector (Open) | 1,250 | Pre-2026 redesign - open intake |
| Jul 22, 2025 | Priority Sector (Open) | 1,180 | Pre-2026 redesign - open intake |
| Apr 14, 2025 | Priority Sector (Open) | 1,320 | Pre-2026 redesign - open intake |
| Jan 13, 2025 | Priority Sector (Open) | 1,290 | Pre-2026 redesign - open intake |

Priority sectors are open year-round - no window needed.

⚠ Window 3 is open now - positions are limited

Capped sector windows fill within hours of opening. If you work in a capped sector (Tier 2 or 3), VMC prepares your complete SINP package 6-8 weeks in advance so you can submit in the first minutes of the window. Priority sector workers (Tier 1) can apply anytime — no window needed.

### Tier Classification Before Anything Else

SINP's three-tier system is the most consequential eligibility framework in Canadian PNP history. VMC identifies every client's employer NAICS code and occupation tier as the very first step — before any document preparation, before any fee, before any application. If SINP is inaccessible under 2026 rules, VMC identifies alternative pathways immediately so no time or money is wasted.

### Capped Window Preparation - 6 to 8 Weeks in Advance

We begin capped sector client preparation 6 to 8 weeks before each window. The JAF is drafted and reviewed with the employer. All candidate documents are collected and verified. Police certificates are ordered. On window open day, submission happens in the first minutes — not the first hours. Windows 1 and 2 both showed that hours matter. We ensure our clients are among the first submissions when the window opens at 8:30 a.m. CST.

### PGWP and SOWP Eligibility Assessment

Saskatchewan's 2026 restrictions on PGWP and SOWP holders have affected thousands of candidates who planned their permanent residency around pre-2026 SINP eligibility. VMC assesses every PGWP and SOWP client under current rules in the first consultation. Where SINP is closed, we immediately identify the next best pathway — Alberta AAIP, Ontario OINP, Manitoba MPNP, BC PNP, or federal Express Entry.
...
Not every candidate can use SINP in 2026. Capped sector restrictions, PGWP limitations, work permit timing issues, and the reduced allocation all create barriers that did not exist in 2024. We do not simply tell clients they are ineligible and stop. We map alternative pathways immediately: Alberta AAIP has thousands of spaces remaining. Ontario OINP is active again through the new Workforce Priority stream (EOI portal reopening summer 2026). Manitoba MPNP has continuous intake. BC PNP has weekly draws. Federal Express Entry is always an option. We find the path forward.

### Window 3 Is Open Now. Act Before Positions Fill.

VMC prepares capped sector clients' complete SINP packages 6-8 weeks before each window. Window 3 opened May 4 — submit now while positions remain. For priority sector workers, your pathway is open year-round. Book your free SINP assessment.
...
Our team's licensed RCICs confirm your sector tier, verify your employer's NAICS code, assess PGWP and SOWP eligibility under 2026 rules, prepare complete application packages, and ensure capped sector clients submit in the first minutes of every window. Cross-check the [official SINP processing statistics page](https://www.saskatchewan.ca/residents/moving-to-saskatchewan/immigrating-to-saskatchewan) and [IRCC's PNP overview](https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/provincial-nominees.html) for live updates.
...
| Anchor text | URL |
| --- | --- |
| Skip to main content | https://visamastercanada.com/immigration/pnp/saskatchewan#main-content |
...
| Book Your SINP Assessment → | https://visamastercanada.com/free-assessment |
| Free SINP Calculator | https://visamastercanada.com/tools/sinp-calculator |
...
| Book consult → | https://visamastercanada.com/free-assessment |
| Apply During Window 3 Now → | https://visamastercanada.com/free-assessment |
| Calculate My SINP Score → | https://visamastercanada.com/immigration/pnp/saskatchewan#calculator |
| Book appointment | https://visamastercanada.com/book |
| Contact us | https://visamastercanada.com/contact |
| Book Free Consult → | https://visamastercanada.com/free-assessment |
| View All SINP History → | https://visamastercanada.com/pnp-draws?province=sk |
| Book free SINP assessment → | https://visamastercanada.com/book |
| Book Free SINP Assessment → | https://visamastercanada.com/free-assessment |
| 📞 (647) 395-3471 | tel:+16473953471 |
...
| Manitoba MPNP → Manitoba immigration | https://visamastercanada.com/immigration/pnp/manitoba |
...
| Family Sponsorship → Sponsor loved ones | https://visamastercanada.com/immigration/sponsorship/spousal |
...
```json
{"@context":"https://schema.org","@graph":[{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://visamastercanada.com/"},{"@type":"ListItem","position":2,"name":"Immigration","item":"https://visamastercanada.com/immigration"},{"@type":"ListItem","position":3,"name":"Provincial Programs","item":"https://visamastercanada.com/immigration/pnp"},{"@type":"ListItem","position":4,"name":"Saskatchewan SINP","item":"https://visamastercanada.com/immigration/pnp/saskatchewan"}]},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the SINP and what makes it different from other PNPs?","acceptedAnswer":{"@type":"Answer","text":"The Saskatchewan Immigrant Nominee Program is Saskatchewan's provincial pathway to Canadian permanent residence. What makes SINP unique in Canada is its three-tier occupation model, introduced in December 2025. Your employer's NAICS industry code determines your entire access model: priority sector workers (healthcare, agriculture, tech, trades, mining, energy, manufacturing) have open access year-round from anywhere in the world. Capped sector workers (accommodation, food service, trucking, retail) compete in six annual windows that fill within hours. Saskatchewan nominates approximately 70% of all immigrants who settle in the province - a remarkable share reflecting the SINP's central role in the province's immigration story."}},{"@type":"Question","name":"How many SINP spaces are available in 2026 and how are they distributed?","acceptedAnswer":{"@type":"Answer","text":"Saskatchewan's 2026 initial allocation is 4,761 nomination spaces. Distribution: minimum 50% (2,381 spaces) reserved for priority sectors - healthcare, agriculture, skilled trades, mining, manufacturing, energy, and technology. Maximum 25% (1,190 spaces) for capped sectors: accommodation and food services (15%; 714 spaces), trucking (5%; 238 spaces), retail trade (5%; 238 spaces). Remaining 25% for other sectors. Within the priority sector allocation, 750 spaces are specifically reserved for Saskatchewan DLI graduates working in priority sector occupations. Additional nominations may become available throughout 2026 at IRCC's discretion."}},{"@type":"Question","name":"How do I find out which tier my employer falls under?","acceptedAnswer":{"@type":"Answer","text":"Your tier is determined by the NAICS code on your employer's Certificate of Registration (COR). Priority sector NAICS codes include: healthcare (62), agriculture/forestry/fishing (11), mining/oil/gas (21), utilities (22), construction (23), manufacturing (31-33), and professional/tech services (54). Capped sector NAICS codes are: accommodation and food services (72), retail trade (44-45), and trucking/transportation (48-49). If your employer's NAICS code is none of the above, you are in the other sector (Tier 3). We confirms employer NAICS codes in every SINP consultation. Warning: do not misrepresent your employer's NAICS code to avoid restrictions - this constitutes a program integrity violation."}},{"@type":"Question","name":"I work for a healthcare company but my role is administrative. Am I in the priority sector?","acceptedAnswer":{"@type":"Answer","text":"Yes - your tier is based on your employer's industry classification (NAICS code), not your specific job role. If your employer is a hospital, clinic, or healthcare facility classified under NAICS 62, you are in the priority sector regardless of whether your role is nursing, administration, IT, or maintenance. However, the specific SINP pathway you qualify for depends on your NOC code. An administrative worker at a healthcare facility would apply through the ISW Employment Offer subcategory (if they have a JAL) or the EOI-based streams rather than the Health Talent Pathway (which requires a healthcare NOC)."}},{"@type":"Question","name":"When are the remaining 2026 capped sector windows and what are the position limits?","acceptedAnswer":{"@type":"Answer","text":"Window 3 opened May 4, 2026 at 8:30 a.m. CST and is currently accepting applications. Upcoming windows are: Window 4 (July 6, 2026), Window 5 (September 7, 2026), Window 6 (November 2, 2026). Approximate position allocations per window based on annual distribution: Accommodation and Food Services: approximately 60% of each window. Trucking: approximately 20% of each window. Retail Trade: approximately 20% of each window. Total across all three sectors: approximately 300-400 positions per window depending on SINP adjustments. Check the official SINP Processing Statistics page at saskatchewan.ca/sinp-processing-statistics for the most current Window 3 position counts."}},{"@type":"Question","name":"My employer submitted a Job Approval Form in 2025 that was not used. Can they use it in 2026?","acceptedAnswer":{"@type":"Answer","text":"No. Unused Job Approval Letters from 2025 for employers in capped sectors were closed ahead of any 2026 intake rounds. Employers whose 2025 JALs were closed may re-apply in a 2026 intake window if they continue to meet eligibility requirements. All candidate applications already received will continue to be processed. This was a clean-slate reset for the capped sector system."}},{"@type":"Question","name":"I have a PGWP from the University of Calgary and I'm working in Saskatchewan's hospitality sector. What are my SINP options?","acceptedAnswer":{"@type":"Answer","text":"Under 2026 rules, your PGWP from a non-Saskatchewan institution limits you significantly. You cannot use the Existing Work Permit sub-category, the Student Category, or any capped sector pathway (including hospitality/accommodation). Your remaining SINP options are: the Health Talent Pathway (if you work in a healthcare NOC), the Agriculture Talent Pathway (if you work in agriculture), the Innovation and Tech Talent Pathway (if you work in one of 32 eligible tech occupations), or the ISW Employment Offer subcategory (if your job is NOC TEER 0-3 and your employer's sector qualifies and you score 60+ on the grid). If none of these apply to your hospitality role, SINP is effectively inaccessible. We immediately identifies alternative pathways - Alberta AAIP, Ontario OINP, Manitoba MPNP, or federal Express Entry."}},{"@type":"Question","name":"I'm a student at the University of Saskatchewan and I will graduate in 4 months. What SINP pathway should I prepare for?","acceptedAnswer":{"@type":"Answer","text":"As a graduating Saskatchewan DLI student, you are in an excellent position. In 2026, 750 dedicated spaces are reserved for Saskatchewan DLI graduates working in priority sector occupations. After graduation, you will apply for your Post-Graduate Work Permit. Once working in Saskatchewan (minimum 6 months required for the Student Category), you can apply through the Student Category. However, if your employment is in a priority sector (healthcare, agriculture, tech, trades, mining, energy, manufacturing), you may also qualify through the relevant talent pathway, potentially with faster access. We help Saskatchewan graduates map out the exact pathway and timing based on their field of study and employment offer."}},{"@type":"Question","name":"How long does the SINP take to process applications?","acceptedAnswer":{"@type":"Answer","text":"Saskatchewan's goal is to process all International Skilled Worker and Saskatchewan Experience applications within 16 weeks, provided all documents are complete and submitted at time of application. In Q4 2025 (October-December 2025), actual processing times were 2 weeks for most categories including Employment Offer, Tech Talent, Agriculture Talent, Health Talent, Existing Work Permit, and International Students. Job Approval Forms also processed in 2 weeks. Second review requests took 2 weeks. Processing times can change - the 16-week goal is the guaranteed target, but recent performance has been significantly faster."}},{"@type":"Question","name":"What happens if my job changes after I receive my nomination?","acceptedAnswer":{"@type":"Answer","text":"Nominees who lose their job or experience a change in employment conditions must notify SINP immediately. Withholding this information is considered misrepresentation. Nominees are given 45 days to find a new job offer from a Saskatchewan employer and receive a new Job Approval Letter. Two additional 45-day extensions are available if needed. If a suitable position is found, nominees should try to find work in the same NOC code but may change occupation if they meet criteria in the new occupation. SINP can revise the stream under which the nominee was originally nominated if required by the circumstances."}},{"@type":"Question","name":"Can I apply to SINP from outside Saskatchewan while working in another Canadian province?","acceptedAnswer":{"@type":"Answer","text":"For priority sector talent pathways (Health, Agriculture, Tech), you can apply from outside Canada entirely - so yes, working in another Canadian province also qualifies. For these pathways, you need the Saskatchewan job offer (JAL) from a Saskatchewan employer. For the ISW Employment Offer subcategory, the pathway description says it is for workers \"who are not working in Saskatchewan\" with the option for those who are - so yes, workers in other provinces with a Saskatchewan job offer may apply. For the Existing Work Permit sub-category and Student Category, you must be physically working in Saskatchewan. Capped sector pathways require you to be in Canada as a temporary resident."}},{"@type":"Question","name":"What is the application fee for SINP in 2026?","acceptedAnswer":{"@type":"Answer","text":"Effective April 1, 2026, the SINP application fee is $500 per applicant (principal applicant) for all worker categories. Applications submitted before April 1, 2026 are not subject to the new fee. A second review fee of $250 applies if you request reconsideration of an ineligible decision - this fee applies from April 1, 2026 for all worker applicants. Previously, skilled worker applications with job offers were free, and only applications without job offers were subject to the $500 fee. The fee increase is expected to generate approximately $2.9 million in additional revenue to recover program administration costs."}}]},{"@type":"Service","name":"Saskatchewan SINP Immigration Services","serviceType":"Immigration Consulting","provider":{"@type":"LocalBusiness","name":"Licensed Regulated Canadian Immigration Consultants","address":"83 Kennedy Rd S Unit 16, Brampton, Ontario","telephone":"+16473953471"},"areaServed":"Saskatchewan, Canada","description":"Licensed RCIC guidance for SINP - three-tier system, priority and capped sectors, intake windows, 110-point grid, and complete application packages."}]}
```

```json
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://visamastercanada.com"},{"@type":"ListItem","position":2,"name":"Home","item":"https://visamastercanada.com/"},{"@type":"ListItem","position":3,"name":"Immigration","item":"https://visamastercanada.com/immigration"},{"@type":"ListItem","position":4,"name":"Provincial Programs","item":"https://visamastercanada.com/immigration/pnp"},{"@type":"ListItem","position":5,"name":"Saskatchewan"}]}
```
